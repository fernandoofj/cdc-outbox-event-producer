 ...
 * [br.com.fltech.outbox.publisher.replication.config.PostgresConfiguration],
 * [br.com.fltech.outbox.publisher.replication.config.ReplicationConfiguration],
 * [br.com.fltech.outbox.publisher.replication.connector.HikariCPConnectionProvider.PoolConfig]
 * and [br.com.fltech.outbox.publisher.retry.ExponentialBackOff].
 *
...
data class CdcOutboxProperties(
    ...
    data class Processor(
         ...
         *    [br.com.fltech.outbox.publisher.core.application.CdcProcessor]
         *    driven by the [br.com.fltech.outbox.publisher.core.port.EventSinkRegistry]
     ...
     * [br.com.fltech.outbox.publisher.core.port.CheckpointStore] bean
     * that source adapters consult on `open()` and persist to on `ack()`.
     */
    data class Checkpoint(
        /**
         * When true, the auto-configuration wires a default
         * [br.com.fltech.outbox.publisher.adapter.checkpoint.FileCheckpointStore]
