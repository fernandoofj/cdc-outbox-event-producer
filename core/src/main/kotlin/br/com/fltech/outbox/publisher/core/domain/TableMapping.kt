...
data class TableMapping(
     ...
     * destination consumed by [br.com.fltech.outbox.publisher.core.port.EventSinkRegistry]
    ...
    data class Routing(
        ...
        init {
            ...
            require(br.com.fltech.outbox.publisher.core.domain.Routing.SCHEME_SEPARATOR in sink) {
