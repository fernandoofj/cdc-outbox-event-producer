...
/**
 * Abstract row-level change event surfaced by a [br.com.fltech.cdc.outbox.publisher.core.port.CdcSource]
 * before the [br.com.fltech.cdc.outbox.publisher.core.port.MappingRules]
