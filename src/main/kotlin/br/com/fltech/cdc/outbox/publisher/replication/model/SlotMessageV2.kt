 ...
 * adapter [br.com.fltech.cdc.outbox.publisher.adapter.source.postgres.PgWalRowChangeSource]
 * can emit fully-populated [br.com.fltech.cdc.outbox.publisher.core.domain.RowChange]
 ...
 * [br.com.fltech.cdc.outbox.publisher.core.domain.RowChange] `before`/
 * `after` maps without an extra typing pass.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
class Wal2JsonColumn @JsonCreator constructor(
